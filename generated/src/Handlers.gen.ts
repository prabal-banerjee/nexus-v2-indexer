...
import type {EvmOnEventContext as Types_EvmOnEventContext} from './Types.gen';
...
export const Vault_Deposit_handler: Types_fnWithEventConfig<Internal_genericHandler<Internal_genericHandlerArgs<Types_Vault_Deposit_event,Types_EvmOnEventContext,void>>,Types_HandlerTypes_eventConfig<Types_Vault_Deposit_eventFilters>> = HandlersJS.Vault.Deposit.handler as any;

export const Vault_Deposit_handlerWithLoader: <loaderReturn>(_1:Internal_genericHandlerWithLoader<Internal_genericLoader<Internal_genericLoaderArgs<Types_Vault_Deposit_event,Types_loaderContext>,loaderReturn>,Internal_genericHandler<Internal_genericHandlerArgs<Types_Vault_Deposit_event,Types_EvmOnEventContext,loaderReturn>>,Types_Vault_Deposit_eventFilters>) => void = HandlersJS.Vault.Deposit.handlerWithLoader as any;
...
export const Vault_Fulfilment_handler: Types_fnWithEventConfig<Internal_genericHandler<Internal_genericHandlerArgs<Types_Vault_Fulfilment_event,Types_EvmOnEventContext,void>>,Types_HandlerTypes_eventConfig<Types_Vault_Fulfilment_eventFilters>> = HandlersJS.Vault.Fulfilment.handler as any;

export const Vault_Fulfilment_handlerWithLoader: <loaderReturn>(_1:Internal_genericHandlerWithLoader<Internal_genericLoader<Internal_genericLoaderArgs<Types_Vault_Fulfilment_event,Types_loaderContext>,loaderReturn>,Internal_genericHandler<Internal_genericHandlerArgs<Types_Vault_Fulfilment_event,Types_EvmOnEventContext,loaderReturn>>,Types_Vault_Fulfilment_eventFilters>) => void = HandlersJS.Vault.Fulfilment.handlerWithLoader as any;

/** Register a Block Handler. It'll be called for every block by default. */
export const onBlock: (_1:Envio_onBlockOptions<Types_chain>, _2:((_1:Envio_onBlockArgs<Types_EvmOnEventContext>) => Promise<void>)) => void = HandlersJS.onBlock as any;
...
export const Vault: { Deposit: {
  ...
  handler: Types_fnWithEventConfig<Internal_genericHandler<Internal_genericHandlerArgs<Types_Vault_Deposit_event,Types_EvmOnEventContext,void>>,Types_HandlerTypes_eventConfig<Types_Vault_Deposit_eventFilters>>; 
  ...
  handlerWithLoader: <loaderReturn>(_1:Internal_genericHandlerWithLoader<Internal_genericLoader<Internal_genericLoaderArgs<Types_Vault_Fulfilment_event,Types_loaderContext>,loaderReturn>,Internal_genericHandler<Internal_genericHandlerArgs<Types_Vault_Fulfilment_event,Types_EvmOnEventContext,loaderReturn>>,Types_Vault_Fulfilment_eventFilters>) => void; 
  handler: Types_fnWithEventConfig<Internal_genericHandler<Internal_genericHandlerArgs<Types_Vault_Fulfilment_event,Types_EvmOnEventContext,void>>,Types_HandlerTypes_eventConfig<Types_Vault_Fulfilment_eventFilters>>; 
